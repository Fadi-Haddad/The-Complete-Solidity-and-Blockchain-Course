...
Solidity provides inbuilt cryptographic functions as well. here are some important methods:
...
// A database management system that is not only used for storing the data but to effectively manage 
